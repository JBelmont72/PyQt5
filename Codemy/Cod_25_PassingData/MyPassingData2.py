...
What we’ll add: from  ChatGPT https://chatgpt.com/c/683f6685-7500-800f-9d41-d76f34d4c7fb
A QPushButton in the second window labeled "Clear Combo".
When clicked, it will remove the last item added to the comboBox, or clear the entire list (based on your preference—I'll do "clear all" for now).
You can also add a QLineEdit to let the user type in an item to remove just that one, if you prefer.
🔧 Updated SecondWindow code with a "Clear Combo" button:
