...
File "/Users/judsonbelmont/Documents/SharedFolders/Pico/PyQt5/Codemy/MyCalc_1.py", line 31
    self.ResultLabel.setFrameShape(QtCore.Qt.QFrame::Shape::Box)    
...
#         self.ResultLabel.setGeometry(QtCore.QRect(20, 20, 471, 61))
#         font = QtGui.QFont()
...
# # Use QtWidgets.QFrame instead of QtCore.QFrame
#         self.ResultLabel.setFrameShape(QtWidgets.QFrame.Box)  # Corrected line
#         self.ResultLabel.setFrameShadow(QtWidgets.QFrame.Raised)  # Corrected line        
        
#         # self.ResultLabel.setFrameShape(QtCore.Qt.QFrame::Shape::Box)
#         # self.ResultLabel.setFrameShadow(QtCore.Qt.QFrame::Shadow::Raised)
#         self.ResultLabel.setLineWidth(4)
#         self.ResultLabel.setMidLineWidth(2)
        
#         self.ResultLabel.setTextFormat(QtCore.Qt.TextFormat.RichText)
#         self.ResultLabel.setAlignment(QtCore.Qt.AlignCenter)  # Corrected line
...
#         self.oneButton = QtWidgets.QPushButton(self.centralwidget) ## changed from clicked =lambda:self.press_it('1')   
...
#         self.ResultLabel.setText(_translate("MyCalculator", "0"))
...
#         else:
#             self.ResultLabel.setText(pressed)
#             ##self.ResultLabel.setText(f'{self.ResultLabel.setText(pressed)}')
...
#     MainWindow.show()
#     sys.exit(app.exec_())
#########~~~~~~~~~~~ i am repurposing square and pi buttons to open and close parentheses
from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5.QtWidgets import QFrame  # I added- Import QFrame from QtWidgets recommended
...
# Use QtWidgets.QFrame instead of QtCore.QFrame
    ...
    def retranslateUi(self, MyCalculator):
        ...
        self.nineButton.setText(_translate("MyCalculator", "9"))
        self.eightButton.setText(_translate("MyCalculator", "8"))
        self.squareButton.setText(_translate("MyCalculator", "("))
        self.sevenButton.setText(_translate("MyCalculator", "7"))
        self.sixButton.setText(_translate("MyCalculator", "6"))
        self.fiveButton.setText(_translate("MyCalculator", "5"))
        self.squareRootButton.setText(_translate("MyCalculator", "SqRt"))
        ...
        self.threeButton.setText(_translate("MyCalculator", "3"))
        self.twoButton.setText(_translate("MyCalculator", "2"))
        self.piButton.setText(_translate("MyCalculator", ")"))
        self.oneButton.setText(_translate("MyCalculator", "1"))
        self.PlusMinusButton.setText(_translate("MyCalculator", "+/-"))
        self.sineButton.setText(_translate("MyCalculator", "sin"))
        self.pointButton.setText(_translate("MyCalculator", "."))
