'''
start with the template.py and change QWidget to QMainWindow

instead of a loayout, we are going to use a central widget.Can be any widget.  (Did not have this when we used QWidget before)
...
class MainWindow(qtw.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        layout =qtw.QVBoxLayout()   #creates a vertical layout for the main windows central area
